...
namespace wrench.auto.repair.ordem.servico.application.tests
{
    public class DiagnosticoTests
    {
        ...
        public DiagnosticoTests()
        {
            ...
            _handler = new DiagnosticoCommandHandler(_diagnosticoRepositoryMock.Object, _ordemServicoRepositoryMock.Object);
        }
        ...
        public async Task SolicitarDiagnostico_OrdemServico_Valida_Com_Sucesso()
        {
            ...
            _ordemServicoRepositoryMock.Verify(repo => repo.ObterPorIdAsync(It.IsAny<Guid>()), Times.Once);
        }
