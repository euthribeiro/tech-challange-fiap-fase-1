...
namespace wrench.auto.repair.core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarSeCorrespondeAExpressaoRegular(string valor, string pattern, string mensagem)
        {
            if (Regex.IsMatch(valor, pattern))
                throw new DomainException(mensagem);
        }

        public static void ValidarSeNaoCorrespondeAExpressaoRegular(string valor, string pattern, string mensagem)
        {
            if (!Regex.IsMatch(valor, pattern))
                throw new DomainException(mensagem);
        }

        public static void ValidarSeNaoCorrespondeAExpressaoRegular(string value, Regex regex, string mensagem)
        {
